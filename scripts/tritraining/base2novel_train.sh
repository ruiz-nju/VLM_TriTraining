...
# sh scripts/tritraining/base2novel_train.sh dtd PromptSRC 16 0 1 1
MODEL_DIR=output/${TRAINER}/base2novel_train/${DATASET}/${CLASSIFIER}/shots_${SHOTS}/unlabeled_shots_${UNLABELED_SHOTS}/seed_${SEED}
DIR=output/${TRAINER}/base2novel_train/${DATASET}/${CLASSIFIER}/shots_${SHOTS}/unlabeled_shots_${UNLABELED_SHOTS}/seed_${SEED}
